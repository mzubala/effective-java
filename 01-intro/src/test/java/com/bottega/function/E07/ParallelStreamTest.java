...
public class ParallelStreamTest {
    ...
    public void parallelSync() {
        ...
        long seconds = countSeconds(() -> ParallelCollectionProcessingCompletableFutureStream.parallelSync(list, i -> withDelay(i), executor));
    ...
    public void parallelAsync() {
        ...
        long seconds = countSeconds(() -> ParallelCollectionProcessingCompletableFutureStream.parallelAsync(list, i -> withDelay(i), executor).join());
